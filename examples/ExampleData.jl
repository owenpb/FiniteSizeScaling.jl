...
export example_data_with_error
export example_data_no_error
export example_fit_weights
export example_x_scaled_one_var
export example_y_scaled_one_var
export example_x_scaled_two_var
export example_y_scaled_two_var
...
example_data_with_error = [[X_L4, Y_L4, E_L4, 4], [X_L6, Y_L6, E_L6, 6], [X_L8, Y_L8, E_L8, 8], [X_L10, Y_L10, E_L10, 10], [X_L12, Y_L12, E_L12, 12]]
example_data_no_error = [[X_L4, Y_L4, 4], [X_L6, Y_L6, 6], [X_L8, Y_L8, 8], [X_L10, Y_L10, 10], [X_L12, Y_L12, 12]]

example_fit_weights = [1 ./ (E_L4 .^ 2), 1 ./ (E_L6 .^ 2), 1 ./ (E_L8 .^ 2), 1 ./ (E_L10 .^ 2), 1 ./ (E_L12 .^ 2)]

example_x_scaled_one_var(X, L, v1) = (X .- v1) * L
example_y_scaled_one_var(Y, L, v1) = Y * (L^(-7 / 4))

example_x_scaled_two_var(X, L, v1, v2) = (X .- v1) * L
example_y_scaled_two_var(Y, L, v1, v2) = Y * (L^(-1 * v2))
